...
namespace EasyTools.Editor {
	...
	/// </summary>
	public abstract class InternalEditor : UEditor {
		...
		private static Assembly editorAssembly = Assembly.GetAssembly(typeof(UEditor));
		...
		public InternalEditor(string editorTypeName) {
