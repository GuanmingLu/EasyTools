	...
	public class SerializableDictionaryDrawer : PropertyDrawer {
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
			...
			if (property.isExpanded) {
				...
				buttonPosition.height = EditorGUIUtility.singleLineHeight +	EditorGUIUtility.standardVerticalSpacing;
				...
				foreach (var entry in EnumerateEntries(keyArrayProperty, valueArrayProperty)) {
					...
					float lineHeight = DrawKeyValueLine(keyProperty, valueProperty, linePosition, i) + EditorGUIUtility.standardVerticalSpacing;
		...
		public override float GetPropertyHeight(SerializedProperty property, GUIContent label) {
			...
			if (property.isExpanded) {
				...
				if (conflictState.conflictIndex != -1) {
					propertyHeight += conflictState.conflictLineHeight + EditorGUIUtility.standardVerticalSpacing;
				}
			}
